...
//cut -1".Split(Environment.NewLine);
            ...
            long iters = 101741582076661;
            long seed = 2020;
            long a = 108_372_218_693_556;
            long b = 113_638_587_256_714;
            BigInteger term1 = (BigInteger.ModPow(a, iters, numCards) * seed) % numCards;
            BigInteger term2 = BigInteger.ModPow(a, iters, (a - 1) * (BigInteger)numCards) - 1;
            term2 = term2 / (a - 1);
            term2 = term2 * b;
            Console.WriteLine((term1 + term2) % numCards);
